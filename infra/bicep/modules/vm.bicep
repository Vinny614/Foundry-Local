...
resource vmExtension 'Microsoft.Compute/virtualMachines/extensions@2024-03-01' = {
  ...
  properties: {
    ...
    protectedSettings: {
      commandToExecute: 'powershell -ExecutionPolicy Bypass -Command "$baseUrl = \'https://raw.githubusercontent.com/Vinny614/Foundry-Local/main\'; New-Item -ItemType Directory -Path C:\\FoundryDemo\\agent -Force; try { Invoke-WebRequest -Uri \"$baseUrl/vm/bootstrap/install_foundry_local.ps1\" -OutFile C:\\FoundryDemo\\install_foundry_local.ps1 -UseBasicParsing; Invoke-WebRequest -Uri \"$baseUrl/vm/bootstrap/install_db_and_seed_data.ps1\" -OutFile C:\\FoundryDemo\\install_db_and_seed_data.ps1 -UseBasicParsing; Invoke-WebRequest -Uri \"$baseUrl/vm/bootstrap/start_mcp_server.ps1\" -OutFile C:\\FoundryDemo\\start_mcp_server.ps1 -UseBasicParsing; Invoke-WebRequest -Uri \"$baseUrl/vm/bootstrap/lock_down_offline.ps1\" -OutFile C:\\FoundryDemo\\lock_down_offline.ps1 -UseBasicParsing; Invoke-WebRequest -Uri \"$baseUrl/vm/bootstrap/verify_offline.ps1\" -OutFile C:\\FoundryDemo\\verify_offline.ps1 -UseBasicParsing; Invoke-WebRequest -Uri \"$baseUrl/app/agent.py\" -OutFile C:\\FoundryDemo\\agent\\agent.py -UseBasicParsing; Invoke-WebRequest -Uri \"$baseUrl/app/requirements.txt\" -OutFile C:\\FoundryDemo\\agent\\requirements.txt -UseBasicParsing; Invoke-WebRequest -Uri \"$baseUrl/app/example_queries.txt\" -OutFile C:\\FoundryDemo\\agent\\example_queries.txt -UseBasicParsing; Write-Output \'Scripts downloaded successfully\' | Out-File C:\\FoundryDemo\\download_log.txt } catch { Write-Output \"Error: $_\" | Out-File C:\\FoundryDemo\\download_error.txt }"'
    }
  }
}
